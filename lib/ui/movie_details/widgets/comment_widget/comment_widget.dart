    ...
    return SafeArea(
      child: Padding(
        padding: EdgeInsets.fromLTRB(
            20, 15, 20, 10 + MediaQuery.of(context).viewInsets.bottom),
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: widget.movieModel.comment != null &&
                      widget.movieModel.comment!.isNotEmpty
                      ...
                      builder: (context, user, child) {
                        return ValueListenableBuilder(
                          ...
                          builder: (context, movie, child) {
                            final movieMatches =
                                movie.where((e) => e.id == widget.movieModel.id);
            ...
            Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  child: Text(
                    widget.usermodel.fullName.isNotEmpty
                        ...
                        : '?',
                    style: TextStyle(color: AppColors.avatarIcon, fontSize: 14),
                  ),
                ),
                SizedBox(width: AppColors.space12),
                Expanded(
                ...
                Material(
                  ...
                  child: InkWell(
                    customBorder: CircleBorder(),
                    onTap: () => MovieController.submitComment(
                        widget.controller, widget.usermodel, widget.movieModel),
                    child: Padding(

              ...
              child: Column(
                ...
                children: [
                  ...
                  AddingPageTextFormStyle(
                      ...
                      maxLine: 5),
                  AddingPageTextFormStyle(
                      hint: 'Please enter the Overview about the movie',
                      validation: (value) => value == null || value.isEmpty,
                      controller: _points,
                      label: 'Overview ',
                      textForValidatoin: 'Please enter the Overview about the movie',
                  ...
                  // ignore: deprecated_member_use
                  ButtonInAdding(text: 'Edit Movie',
                    // ignore: deprecated_member_use
                    bagroundColor: isDark.value? Colors.grey[900]:Colors.grey.withOpacity(0.5),
                    function: () => edit(
                      context,
                    ),
                    height: 0.06,

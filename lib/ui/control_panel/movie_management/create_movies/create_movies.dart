...
class MovieAddingPage extends StatefulWidget {
  const MovieAddingPage({super.key});

  @override
  State<MovieAddingPage> createState() => _MovieAddingPageState();
}

class _MovieAddingPageState extends State<MovieAddingPage> {
  late final MovieFormController _controller;

  @override
  void initState() {
    super.initState();
    _controller = MovieFormController();
  }
  ...
  void _openAddCastDialog() {
    showDialog(
      context: context,
      builder: (_) => AddCastDialog(controller: _controller),
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                AppTextField(
                  ...
                  hint: 'Movie Title',
                  icon: Icons.title,
                  validator: (v) => MovieFormController.requiredField(
                ...
                AppTextField(
                  ...
                  validator: MovieFormController.urlField,
                ),
                const SizedBox(height: AppColors.space16),
                AppTextField(
